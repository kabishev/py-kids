...
Курс разделён на уроки для последовательного изучения. Рекомендуется проходить 1 урока в неделю, с обсуждением результатов.

## 🚀 Подготовка окружения

### Требования
- Python 3.14 или выше
- `uv` — современный менеджер пакетов Python (установить: `pip install uv` или `brew install uv`)
...
В конце курса ребёнок создаст программу, визуализирующую алгоритмы (например, анимацию сортировки или поиска пути). Это объединит все навыки: циклы, функции, структуры данных и математику. Используйте текстовый вывод или простые библиотеки (если доступны). Удачи в обучении! 🚀
